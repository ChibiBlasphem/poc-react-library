...
`,Tn=nt(at)`
  margin-right: 10px;
`,vr=(t,n)=>{if(t===void 0)return{percentage:void 0,remainingTime:void 0};const e=Math.min(99,Math.round(100*n/t)),a=Math.round(t-n);return{percentage:e,remainingTime:a}},pr=t=>{const[n,e]=St.exports.useState(t),a=()=>e(0);return St.exports.useEffect(()=>{const r=setInterval(()=>{e(o=>o+1)},1e3);return()=>{clearInterval(r)}},[]),{reset:a,delta:n}},br=t=>t===void 0?"no time estimation available":`about ${be(t)} remaining`;function Z({planned:t,elapsed:n=0,triggerer:e}){const{reset:a,delta:r}=pr(0),{percentage:o,remainingTime:i}=vr(t,n+r),s=br(i);return St.exports.useEffect(()=>{a()},[n]),yt("div",{role:"progressbar","aria-valuenow":o,"aria-valuemin":0,"aria-valuemax":100,children:[t!==void 0&&K(ur,{children:K("div",{className:"elapsed",style:{width:`${o}%`}})}),yt(mr,{children:[K(Tn,{icon:ve})," ",s]}),yt(dr,{children:[K(Tn,{icon:pe})," initiated by ",e]})]})}try{Z.displayName="ProgressBar",Z.__docgenInfo={description:"",displayName:"ProgressBar",props:{planned:{defaultValue:null,description:"",name:"planned",required:!1,type:{name:"number"}},elapsed:{defaultValue:null,description:"",name:"elapsed",required:!1,type:{name:"number"}},triggerer:{defaultValue:null,description:"",name:"triggerer",required:!1,type:{name:"string"}}}},typeof STORYBOOK_REACT_CLASSES!="undefined"&&(STORYBOOK_REACT_CLASSES["src/ProgressBar/ProgressBar.tsx#ProgressBar"]={docgenInfo:Z.__docgenInfo,name:"ProgressBar",path:"src/ProgressBar/ProgressBar.tsx#ProgressBar"})}catch{}var Or={parameters:{storySource:{source:`import React from 'react';
...
`,locationsMap:{"no-estimation-bar":{startLoc:{col:53,line:10},endLoc:{col:88,line:10},startBody:{col:53,line:10},endBody:{col:88,line:10}},"with-estimation":{startLoc:{col:53,line:10},endLoc:{col:88,line:10},startBody:{col:53,line:10},endBody:{col:88,line:10}},"with-triggerer":{startLoc:{col:53,line:10},endLoc:{col:88,line:10},startBody:{col:53,line:10},endBody:{col:88,line:10}}}}},title:"ProgressBar",component:Z};const Zt=t=>K(Z,en({},t)),Sr=Zt.bind({}),gr=Zt.bind({});gr.args={planned:30};const hr=Zt.bind({});hr.args={triggerer:"ChibiKookie"};const Pr=["NoEstimationBar","WithEstimation","WithTriggerer"];export{Sr as NoEstimationBar,gr as WithEstimation,hr as WithTriggerer,Pr as __namedExportsOrder,Or as default};
//# sourceMappingURL=ProgressBar.stories.b49c87c1.js.map
